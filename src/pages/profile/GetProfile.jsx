...
const GetProfile = () => {
  ...
  const updateProfile = async (e) => {
    ...
    try {
      ...
      await API.put("/api/v1/productStore/users/updateDetails", form);
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#081120] border border-[#182235] rounded-3xl p-8">
            ...
            <p className="text-gray-400 text-center mt-2">{profile.email}</p>
          ...
          <div className="lg:col-span-2 bg-[#081120] border border-[#182235] rounded-3xl p-8">
            <h2 className="text-2xl font-bold mb-8">Update Information</h2>
